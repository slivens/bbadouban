<template>
  <div class="header-bar">
    <h1 class="title">
      <router-link style="color: #2384E8" :to="{ path: '/Home'}">
         BBA
      </router-link>
    </h1>
    <ul class="nav">
      <li>
        <router-link style="color: #2384E8" :to="{ path: '/MovieView'}">
          电影
        </router-link>
      </li>
      <li>
        <router-link style="color: #9F7860" :to="{ path: '/BookView'}">
          图书
        </router-link>
      </li>
      <li>
        <router-link style="color: #E4A813" :to="{ path: '/StatusView'}">
          广播
        </router-link>
      </li>
      <li>
        <router-link style="color: #2AB8CC" :to="{ path: '/GroupView'}">
          小组
        </router-link>
      </li>
    </ul>
